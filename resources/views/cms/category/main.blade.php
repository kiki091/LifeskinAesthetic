<div class="main--content" id="template_category">
    <h3 class="main--content__title">CATEGORY MANAGER</h3>
            ...
            <div class="media--accordion">
                <div class="media--accordion__body">
                    <ul class="media__wrapper margin0 sortable" id="sort">
                        <li class="media sort-item" v-bind:data-id="category_data.id" v-for="category_data in data">
                            <div class="media__group flex">
                                <div class="media__text">
                                    <a href="#" class="content__edit__hover" @click="editData(category_data.id)">
                                        <h6 class="s14">@{{ category_data.name }}</h6>
                                    </a>
                                </div>
                            </div>
                            <div class="media__control">
                                <a href="#" @click="showDeleteForm(category_data.id)" class="ico-delete margin-x5">@include('svg-logo.ico-delete')</a>
                            </div>
                        </li>
                    </ul>  
                </div>
