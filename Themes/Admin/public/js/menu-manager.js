    ...
    var controller = new Vue({
        ...
        methods: {
            ...
            refresh: function refresh() {
                ...
                $('#error-group-title').text('Required');
                $('#error-uri-title').text('Required');
            ...
            fetchFormData: function fetchFormData() {
                ...
                this.$http.get(domain).then(function (response) {
                    return_data = response.data;
                    vm.group_manager = return_data.data;
                });
            },
            addData: function addData() {
                ...
                this.$http.post(domain, payload, function (resp) {
                    if (resp.status === '' || resp.status === undefined) {
                        if (resp.name) $('#error-name-title').text(resp.name);else $('#error-name-title').text('');

                        if (resp.group) $('#error-group-title').text(resp.group);else $('#error-group-title').text('');

                        if (resp.uri) $('#error-uri-title').text(resp.uri);else $('#error-uri-title').text('');
            ...
            editData: function editData(id) {
                ...
                this.$http.get(domain + id).then(function (response) {
                    $.each(response.data, function (index, key) {
                        ...
                        data_managers.function_js = key.function_js;
            ...
            reorder: function reorder(oldIndex, newIndex) {
                ...
                id_from = ids[oldIndex].getAttribute('data-id');
                id_to = ids[newIndex].getAttribute('data-id');
                ...
                this.$http.post(domain, payload, function (resp) {
                    ...
                    } else pushNotif(resp.status, resp.message);
                });
            },
...
},{"./../../views/components/select.vue":5}],5:[function(require,module,exports){
;(function(){
'use strict';
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-726d5f30", __vue__options__)
  } else {
    hotAPI.rerender("data-v-726d5f30", __vue__options__)
  }
})()}
