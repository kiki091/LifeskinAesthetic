...
},{"./pages/accounts/admin-manager":6,"./pages/accounts/controller-manager":7,"./pages/accounts/function-manager":8,"./pages/accounts/group-manager":9,"./pages/accounts/menu-manager":10,"./pages/accounts/role-manager":11,"./pages/accounts/system-manager":12,"./pages/newsletter/subscriber-manager":13,"./pages/seo/seo-manager":14}],6:[function(require,module,exports){
'use strict';
...
module.exports = function crudAdmin() {
    var controller = new Vue({
        ...
        components: {
            Ftext: _text2.default, Fcheckbox: _checkbox2.default
        },
        methods: {
            ...
            fetchAdmin: function fetchAdmin() {
                ...
                this.$http.post(domain, payload).then(function (response) {
                    if (response.data.status === '') {
                        ...
                        $.each(response.data, function (index, obj) {
                            if (index != 'status' && obj != '') messages.push(obj);
                        });
...
},{"./../../views/components/checkbox.vue":15,"./../../views/components/text.vue":18}],7:[function(require,module,exports){
'use strict';
...
},{"./../../views/components/text.vue":18}],8:[function(require,module,exports){
'use strict';
...
module.exports = function functionmanager() {
    ...
    var controller = new Vue({
        ...
        components: {
            Ftext: _text2.default, Ftexteditor: _ckeditor2.default, Fchosen: _chosen2.default
        },
        methods: {
            changeButton: function changeButton() {
                this.edit = false;
...
},{"./../../views/components/chosen.vue":16,"./../../views/components/ckeditor.vue":17,"./../../views/components/text.vue":18}],9:[function(require,module,exports){
'use strict';
...
module.exports = function menugroupmanager() {
    ...
    var controller = new Vue({
        ...
        components: {
            Ftext: _text2.default, Fchosen: _chosen2.default
        },
        methods: {
            changeButton: function changeButton() {
                this.edit = false;
            ...
            fetchFormData: function fetchFormData() {
                ...
                this.$http.get(domain).then(function (response) {
                    ...
                    if (response.data.status === false) notify({ type: 'error' });
                });
            },
            addData: function addData() {
...
},{"./../../views/components/chosen.vue":16,"./../../views/components/text.vue":18}],10:[function(require,module,exports){
'use strict';
...
module.exports = function menumanager() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            data: {},
            group_manager: [{ id: 1, text: 'Hello' }, { id: 2, text: 'World' }],
            identifier: identifier_url,
            options: [],
            edit: false
        },
        components: {
            Fchosen: _chosen2.default, Ftext: _text2.default
        },
        methods: {
            changeButton: function changeButton() {
                this.edit = false;
...
},{"./../../views/components/chosen.vue":16,"./../../views/components/text.vue":18}],11:[function(require,module,exports){
'use strict';
...
},{"./../../views/components/checkbox.vue":15,"./../../views/components/text.vue":18}],12:[function(require,module,exports){
'use strict';
...
},{"./../../views/components/text.vue":18}],13:[function(require,module,exports){
'use strict';
...
module.exports = function seomanager() {
    ...
    var controller = new Vue({
        ...
        components: {
            Ftext: _text2.default, Ftexteditor: _ckeditor2.default
        },
        methods: {
            ...
            storeData: function storeData(event) {
            ...
            resetForm: function resetForm(setEditToFalse) {
...
},{"./../../views/components/ckeditor.vue":17,"./../../views/components/text.vue":18}],15:[function(require,module,exports){
;(function(){
'use strict';
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-3f5a83ce", __vue__options__)
  }
})()}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-c65ec686", __vue__options__)
  }
})()}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-7a664ee0", __vue__options__)
  }
})()}
},{"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],18:[function(require,module,exports){
;(function(){
'use strict';
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-549a59b8", __vue__options__)
  }
})()}
