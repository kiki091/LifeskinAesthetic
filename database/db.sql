...
CREATE TABLE `cart_detail` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_cart_detail_1_idx` (`product_id`),
  CONSTRAINT `fk_cart_detail_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `package_product` VALUES (7,3,1,NULL,NULL),(8,4,1,NULL,NULL),(9,5,1,NULL,NULL);
...
-- Dump completed on 2018-01-09 17:44:45
