...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install The Mighty Facile';
    ...
    public function fire()
    {
        ...
        if ($success) {
            $this->info('Platform ready! You can now login with your username and password at /cms');
        }
    }
